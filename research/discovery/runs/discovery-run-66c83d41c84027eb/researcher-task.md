...
- Trigger fingerprint: `66c83d41c84027eb572c456ec7c5027e39bbd5eb6b2333da17b23021a170dd92`
- Research state fingerprint: `67c3311d8d84d1ef745c3b0c89357a40271197814903f53a570d8cc8fc260dc0`
...
- `research/data/snapshots/futures-dev-bnb-usdt-usdt-20240101-20240830-v1/manifest.yaml`
...
- `research/data/snapshots/futures-dev-xrp-usdt-usdt-20240101-20240830-v1/manifest.yaml`
...
- `research/governance/approvals/bnb-xrp-development-descriptive-research-scope-v1-approval.json`
...
```json
{
  ...
  "query_terms": [
    "native knowledge learning loop e2e v1",
    "manual request",
  ...
  "selected_patterns": [
    ...
    },
    {
      ...
      "mechanism_summary_zh": "把信号、订单意图和持仓状态分开，使交易变化可以归因。",
      "pattern_id": "explicit-order-intent",
      "proposal_eligibility": "inspiration_only_requires_A_or_B",
      "score": 90,
      "strategy_family": "execution_semantics",
      "title_zh": "显式订单意图"
    },
    {
  ...
  "selection_fingerprint": "810651b90b0d5a1ff2ce32ec019ed0023678883bdd15ac9494f9110140699973",
  "selection_id": "knowledge-selection-9e8744bc518b8985",
  "trigger_fingerprint": "66c83d41c84027eb572c456ec7c5027e39bbd5eb6b2333da17b23021a170dd92"
}
```
...
Write only `research-idea-v1` JSON objects to this absolute system TEMP inbox: `C:\Users\paodi\AppData\Local\Temp\freqtrade-research-discovery\a5fb27a31b427c66\discovery-run-66c83d41c84027eb\researcher`. The inbox is untrusted staging and is outside the governed repository. Do not modify the trigger or task packet.
