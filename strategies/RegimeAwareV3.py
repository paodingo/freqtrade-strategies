"""RegimeAware V3 — long + short, trend + ranging, contract-friendly."""
import logging
import traceback
...
class RegimeAwareV3(IStrategy):
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime,
        ...
        if "trending" in entry_mode:
            ...
            if ema21_4h > 0 and ema55_4h > 0:
                if "_short" in entry_mode and ema21_4h > ema55_4h:
                    return "trending_reversal_short"
                if "_long" in entry_mode and ema21_4h < ema55_4h:
                    return "trending_reversal_long"
