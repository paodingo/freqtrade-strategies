"""RegimeAware V4 — tighter stops, wider ranges, no forced reversals."""
import logging
import traceback
...
class RegimeAwareV4(IStrategy):
    ...
    def _load_4h(self, metadata):
        """Try dp.get_pair_dataframe first, fallback to feather."""
        four_h_ok = False
        informative_4h = None
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # === Ranging signals (V4: wider bands for more signals) ===
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        # V3: no 4h trend-reversal exit — ATR trailing handles exits.
        # Only emergency breakdown exit for ranging long.
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
        ...
        if "trending" in entry_mode:
            # V4: start trailing earlier (1.0x ATR vs 1.5x)
            if current_profit > atr_pct * 1.0:
                return -atr_pct * 1.5
            return -0.07
        else:  # ranging
            return -0.07  # V4: match hard stop to simplify
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime,
        ...
        # V4: no trending_reversal exits — ATR trailing handles all trending closures.
        return None
