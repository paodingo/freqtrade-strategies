...
const LOW_RISK_SURFACES = [
  ...
  { exact: "harness/mappings/v0.1/project-mapping.schema.json" },
  { exact: "harness/mappings/v0.1/mapping-manifest.json" },
  { exact: "harness/mappings/v0.1/projects/freqtrade-strategies.json" },
  { exact: "harness/mappings/v0.1/projects/china-sector-radar.json" },
  { exact: "harness/mappings/v0.1/projects/rehab-intervention.json" },
  { exact: "harness/mappings/v0.1/fixtures/source-stale.json" },
  { exact: "harness/mappings/v0.1/fixtures/authority-weakening.json" },
  { exact: "harness/mappings/v0.1/fixtures/unmapped-gap.json" },
  { exact: "tests/test_harness_project_mapping_guard.py" },
  { exact: "tests/test_harness_project_mapping_contracts.py" },
  { exact: "tests/test_harness_project_mapping_conformance.py" },
  { exact: "harness/distribution/v0.1/distribution-manifest.schema.json" },
  { exact: "harness/distribution/v0.1/fingerprint-profiles.json" },
  { exact: "harness/distribution/v0.1/fingerprint-test-vectors.json" },
  { exact: "harness/distribution/v0.1/release-manifest.json" },
  { exact: "scripts/build_harness_protocol_distribution.py" },
  { exact: "scripts/verify_harness_protocol_distribution.py" },
  { exact: "tests/test_harness_protocol_distribution_contracts.py" },
  { exact: "tests/test_harness_protocol_distribution_reproducibility.py" },
  { exact: "docs/harness/harness-protocol-distribution-policy.md" },
  { exact: "docs/harness/harness-protocol-distribution-policy.zh-CN.html" },
