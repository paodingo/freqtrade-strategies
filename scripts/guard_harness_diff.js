...
const LOW_RISK_SURFACES = [
  ...
  { path: "scripts/build_regime_conditioned_ranging_short_routing_preparation.py" },
  { path: "tests/test_regime_conditioned_ranging_short_routing_preparation.py" },
  { prefix: "research/analysis/regime-conditioned-ranging-short-routing-v1/" },
  { path: "reports/research/regime-conditioned-ranging-short-routing-v1-decision-report.md" },
  { path: "reports/research/regime-conditioned-ranging-short-routing-v1-decision-report.html" },
  { path: "docs/superpowers/plans/2026-07-14-regime-conditioned-ranging-short-routing-v1.md" },
  ...
  { path: "research/analysis/ranging-short-router-carry-context-review-v1/context-coverage-preflight.json" },
  { path: "research/analysis/ranging-short-router-carry-context-review-v1/campaign-stopped.json" },
  { path: "research/analysis/ranging-short-router-carry-context-review-v1/coverage-stop-report.md" },
  { path: "research/candidates/ranging-short-router-carry-context-review-v1/1/RegimeAware_RouterCarryContext_C1.py" },
  { path: "research/candidates/ranging-short-router-carry-context-review-v1/1/candidate-manifest.json" },
  { path: "research/governance/approvals/ranging-short-router-carry-context-review-v1-compilation-approval.json" },
  { path: "scripts/run_ranging_short_router_context_preflight.py" },
  { path: "tests/test_ranging_short_router_context_execution_preflight.py" },
  { path: "scripts/build_ranging_short_router_context_attribution.py" },
  { path: "tests/test_ranging_short_router_context_attribution.py" },
  { path: "research/analysis/ranging-short-router-context-attribution-v1/router-state-attribution.json" },
  { path: "research/analysis/ranging-short-router-context-attribution-v1/context-admissibility-decision.json" },
  { path: "research/analysis/ranging-short-router-context-attribution-v1/final-report.md" },
  { path: "scripts/build_ranging_short_structural_observable_discovery.py" },
  { path: "tests/test_ranging_short_structural_observable_discovery.py" },
  { prefix: "research/analysis/ranging-short-structural-observable-discovery-v1/" },
  { prefix: "research/director/next-after-router-context-attribution/" },
  { prefix: "research/director/compiled/ranging-short-structural-observable-discovery-v1/" },
  { path: "scripts/build_ranging_short_router_indicator_direction_review.py" },
  { path: "tests/test_ranging_short_router_indicator_direction_review.py" },
  { path: "research/governance/ranging-short-router-indicator-direction-contract-v1.json" },
  { prefix: "research/analysis/ranging-short-router-indicator-direction-review-v1/" },
  { prefix: "research/director/next-after-router-indicator-direction-review/" },
  { prefix: "research/director/compiled/ranging-short-router-indicator-direction-review-v1/" },
  { prefix: "research/analysis/ranging-short-router-unanimous-expansion-candidate-preparation-v1/" },
  { prefix: "research/candidates/ranging-short-router-unanimous-expansion-candidate-preparation-v1/" },
  { path: "scripts/rehydrate_frozen_development_snapshot.py" },
  { path: "scripts/run_ranging_short_unanimous_expansion_candidate_preflight.py" },
  { path: "scripts/audit_data_layer_reliability.py" },
  { path: "tests/test_ranging_short_unanimous_expansion_candidate_preflight.py" },
  { path: "tests/test_data_layer_reliability_audit.py" },
