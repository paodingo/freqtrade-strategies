...
class RangingShortBranchRetentionClosureTest(unittest.TestCase):
    ...
    def test_formal_strategy_and_frozen_candidate_hashes_are_preserved(self):
        ...
        self.assertTrue(
            closure_script.checkout_stable_text_sha256_matches(
                ROOT / closure_script.STRATEGY,
                protected["formal_strategy_sha256"],
            )
        )
        self.assertTrue(
            closure_script.checkout_stable_text_sha256_matches(
                ROOT / closure_script.CANDIDATE,
                protected["candidate_sha256"],
            )
        )
